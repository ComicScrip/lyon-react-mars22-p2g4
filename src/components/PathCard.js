...
export default function PathCard({
  ...
  return (
    <Link
      to={`/pathdetails/${id}`}
      id="pathCard"
      className="w-[90%] h-[100px] bg-white/80 border-solid border-2 flex items-center justify-around m-2 p-2 rounded-xl md:flex-col md:w-[30vw] md:h-[40vh] md:max-w-[300px] md:max-h-[400px]"
    >
      <img
        ...
        alt={`parcours : ${title}`}
        id="pathMap"
        className="m-1 p-1 h-[100%] w-[30%] md:w-[80%] md:h-[60%]"
      />
